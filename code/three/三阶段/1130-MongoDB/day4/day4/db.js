...
db.user.find({username:/^l/},{_id:0})
db.user.find({username:/g$/},{_id:0})
db.user.find({username:/^n$/},{_id:0})

var name = "liangliang"
db.user.find({username:new RegExp("^leson$")},{_id:0});
var name = "liangliang"
db.user.find({username:new RegExp("^"+name+"$")},{_id:0});